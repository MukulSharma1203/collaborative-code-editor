...
export default function ProjectDashboardProjects() {
  ...
  const handleFinish = () => {
    if (projectName.trim() && projectName.trim().length > 0) {
            ...
            <el-dialog-panel className="relative transform overflow-hidden rounded-lg bg-gray-900 text-left shadow-xl outline-1 outline-gray-700 transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in w-full max-w-md data-closed:scale-95">
              ...
              <div className="bg-gray-800 px-6 py-4 border-t border-gray-700 flex justify-between items-center">
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-lg font-semibold transition-all duration-200 ${projectName.trim() && !nameError
      ...
      <div className="relative z-10 flex-1 w-full p-6 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-gray-700/50 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 group">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-white font-semibold text-lg">Project Alpha</h3>
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
              </div>
              <p className="text-gray-400 text-sm mb-4">A collaborative coding platform for teams</p>
              <div className="flex items-center gap-2 text-xs text-gray-500">
                <span>Last updated: 2 hours ago</span>
              </div>
            </div>

            {/* delete these at time of main implementation */}
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-gray-700/50 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 group">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-white font-semibold text-lg">Project Alpha</h3>
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
