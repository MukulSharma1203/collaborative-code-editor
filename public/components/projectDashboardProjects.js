...
import { createProject, getUserProjects, deleteProject } from "../../lib/firestoreService";
...
export default function ProjectDashboardProjects() {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <el-dialog>
        <dialog id="deleteProject" aria-labelledby="delete-dialog-title" className="fixed inset-0 size-auto max-h-none max-w-none overflow-y-auto bg-transparent backdrop:bg-transparent">
          <el-dialog-backdrop className="fixed inset-0 bg-gray-900/75 transition-opacity data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in"></el-dialog-backdrop>
            ...
            <el-dialog-panel className="relative transform overflow-hidden rounded-lg bg-gray-900 text-left shadow-xl outline-1 outline-gray-700 transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in w-full max-w-md data-closed:scale-95">
              ...
              <div className="bg-gray-900 px-6 py-4 border-b border-gray-700">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={closeDeleteModal} className="text-gray-400 hover:text-white transition-colors" disabled={deletingProject}>
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                  </button>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                      <p className="text-red-300 text-sm flex items-start gap-2">
                        ...
                        <span>
                          This will permanently delete all project files, settings, and collaborative history. This action cannot be undone.
                        </span>
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-gray-800 px-6 py-4 border-t border-gray-700 flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={deletingProject}
                  className="px-6 py-2 bg-red-500 hover:bg-red-400 text-white rounded-lg font-semibold transition-all duration-200 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-red-500"
                >
                  {deletingProject ? (
                    <>
                      <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-1.5 rounded-full bg-red-500/20 hover:bg-red-500/30 text-red-400 hover:text-red-300 disabled:opacity-50 disabled:cursor-not-allowed"
