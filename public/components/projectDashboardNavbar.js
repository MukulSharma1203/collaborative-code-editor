...
export default function ProjectDashboardNavbar() {
                    ...
                    <div className="flex flex-1 items-center justify-start">
                        <Link href="/dashboard" className="flex gap-2 items-center">
                            ...
                            <h2 className="text-white text-2xl">
                                Code Studio <span className="bg-gradient-to-r from-purple-800 to-blue-700 bg-clip-text text-transparent font-semibold">DashBoard</span>
                            </h2>
                    ...
                    <div className="flex items-center mt-1 justify-end">
                        {isSignedIn && user && (
                            <div className="flex items-center gap-3">
                                <div className="text-white h-10 bg-gradient-to-r from-purple-800/20 to-blue-800/20 border border-purple-500/30 rounded-lg text-sm px-4 py-2 text-center me-3 mb-2 flex items-center gap-2">
                                    <span className="w-full text-transparent bg-clip-text font-semibold bg-gradient-to-r from-blue-500 to-cyan-300 p-2">
                                        Welcome {user.firstName || user.username || 'User'}
                                    </span>
                                </div>
                                <div className="pointer-events-none transform scale-120">
                                    <UserButton />
                                </div>
                                <button command="show-modal" commandfor="dialog" >
                                    <span className="material-symbols-outlined border-2 ml-2 border-red-700 h-10 w-10 rounded-2xl mb-2 pt-1.5 hover:bg-red-800 transition-colors duration-300 ease-in-out">
                                        exit_to_app
                                    </span>
                                </button>
                                <el-dialog>
